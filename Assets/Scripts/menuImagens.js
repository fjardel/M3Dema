...
var proximaImagem : Application;
var anteriorImagem : Application;
...
GUI.skin = ModeloBotao;//pegando o modelo do botao
    ...
    if (GUI.Button(Rect((posiX + 10),(posiY + 45),larguraBotao,alturaBotao),"Proximo")){
    ...
    if(!GetComponent.<AudioSource>().isPlaying){
        ...
        Application.LoadLevel("proximaImagem");//carregando o menu principal
    }
    
    if (GUI.Button(Rect((posiX + 10),(posiY + 80),larguraBotao,alturaBotao),"Anterior")){
    ...
    if(!GetComponent.<AudioSource>().isPlaying){
        ...
        Application.LoadLevel("anteriorImagem");//carregando o menu principal
    }
