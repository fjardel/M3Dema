...
GUI.skin = ModeloBotao;//pegando o modelo do botao
    ...
    if (GUI.Button(Rect((posiX + 10),(posiY + 45),larguraBotao,alturaBotao),"Partes 01")){
    ...
    if(!GetComponent.<AudioSource>().isPlaying){
        ...
        Application.LoadLevel("Visao - Partes - 01");//carregando o menu principal
    }
    
    if (GUI.Button(Rect((posiX + 10),(posiY + 80),larguraBotao,alturaBotao),"Partes 02")){
    ...
    if(!GetComponent.<AudioSource>().isPlaying){
        ...
        Application.LoadLevel("Visao - Partes - 02");//carregando o menu principal
    }
